...
local CMD_APPLY_GPHIL_RENDER = "_RS5739b0e9935eb443c1fafd2b9dc8e0f39e8450a4"
...
local function main()
    ...
    local original_pattern = RENDER_PATTERN_BASE -- Use the constant pattern instead of fetching from project
    ...
    if render_click then
        ...
        elseif CMD_APPLY_GPHIL_CLICK == 0 then
            ...
            -- Restore base tempo map and regular render pattern
            restore_tempo_map(proj, markers_original)
    ...
    if CMD_APPLY_GPHIL_RENDER == 0 then
        ...
        while (step > 0 and tempo <= end_tempo) or (step < 0 and tempo >= end_tempo) do
            ...
            -- Ensure CLICKTRACK muted during regular renders
            ...
            log(string.format(
                ...
                iteration, target_tempo, target_tempo_actual, factor, new_pattern
            ))
    ...
    restore_tempo_map(proj, markers_original)
    -- No need to restore the render pattern since we're using the constant
    -- set_render_pattern(proj, original_pattern)
